...
class VectorStoreService:
    ...
    def load_document(self):
        ...
        def save_md5(md5_str: str):
            ...
            with open(get_abs_path(chroma_conf["md5_hex_store"]), "a", encoding="utf-8") as f: # 以追加模式打开MD5文件
        ...
        for path in allowed_files_path:
            ...
            try:
                ...
                if not split_document:
                    logger.warning(f"[加载知识库]{path}分片内没有有效文本，跳过")
                    continue

                self.vector_store.add_documents(split_document)  # 将内容存入向量库
